...
export type ScenarioLoopStep =
  ...
  | ({ type: "start_negotiation"; participants?: string[]; protocolId?: string; maxRounds?: number; convergenceThreshold?: number })
  | ({ type: "submit_negotiation_position"; actor: string; stance: "support" | "oppose" | "abstain" | "revise"; rationale?: string; score?: number })
  ...
  | ({ type: "run_runtime"; actor: string; runtime?: string; runtimeId?: string })
